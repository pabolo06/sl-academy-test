...
import { LessonDetail, Question, TestAttemptAnswer, TestAttempt, Doubt } from '@/types';
          ...
          <>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              <div className="flex items-center justify-between">
                {['pre-test', 'video', 'post-test', 'completed'].map((step, index) => (
                  <div key={step} className="flex items-center">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                        currentStep === step
                          ? 'bg-blue-600 text-white'
                          : index < ['pre-test', 'video', 'post-test', 'completed'].indexOf(currentStep)
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-gray-900 rounded-lg p-4">
                    ...
                    <p className={`text-2xl font-bold ${
                      calculateImprovement() >= 0 ? 'text-green-400' : 'text-red-400'
                    }`}>
